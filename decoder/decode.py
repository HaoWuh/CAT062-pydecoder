...
class byte_decoder:
    ...
    def __init__(self, data= None, save_name= ""):
        if isinstance(data, str):
            ...
            self.byte_data= [
    0x3e, 0x00, 0x51, 0xbf, 0xbd, 0x01, 0x06, 0x1c, 0x14, 0x01, 0x14, 0xbb, 0xfc, 0x00,
    0x58, 0xc1, 0x3c, 0x01, 0x59, 0x1f, 0x71, 0xff, 0xf9, 0x63, 0x00, 0x06, 0x09, 0x00,
    0x05, 0xff, 0x9d, 0x00, 0x00, 0x00, 0x20, 0x6c, 0x30, 0xc3, 0x0c, 0x79, 0xc1, 0x11,
    0x33, 0x80, 0xf6, 0x00, 0x13, 0x20, 0x6c, 0x30, 0xc3, 0x0c, 0x79, 0x02, 0x00, 0x60,
    0x99, 0x01, 0xb5, 0x15, 0x16, 0x30, 0x53, 0x56, 0x47, 0xdc, 0x00, 0x8b, 0x81, 0x01,
    0x81, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x84, 0x82, 0x82, 0x00
]
        self.result= None
    ...
    def I062_010(self, index_start, index_end):
        ...
        """
        out= dict()
        out["SAC"]= hex(int(self.byte_data[index_start]))
        out["SIC"]= hex(int(self.byte_data[index_start+1]))
